                ...
                ->addColumn('action', function($row){
                    $actionBtn = 
                     '<div class="list-icons">
                        <a href="'.route('halaman.edit', $row->id_posting ).'" class="btn btn-outline-success rounded-round"><i class="icon-zoomin3 mr-2"></i>Detail</a>
                        <a href="'.route('halaman.destroy', $row->id_posting ).' " class="btn btn-outline-danger rounded-round delete-data-table"><i class="icon-trash mr-2"></i>Hapus</a>
                    </div>';
                    return $actionBtn;
                })
