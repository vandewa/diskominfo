        ...
        if($request->ajax()){
            ...
            return DataTables::of($data)
                ...
                '<div class="list-icons">
                    <a href="'.route('daftar.informasi.publik.index', ["root"=>$row->id]).'" class="btn btn-outline-primary rounded-round"><i class="icon-add-to-list mr-2"></i>Tambah Child</a>
                     <a href="'.route('daftar-informasi-publik.edit', $row->id).'" class="btn btn-outline-success rounded-round"><i class="icon-zoomin3 mr-2"></i>Detail</a>
