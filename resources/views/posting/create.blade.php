				...
				<div class="card">
					...
					<div class="card-body">
						...
						<input type="hidden" name ="created_by" value="{{auth()->user()->id}}">
									...
									<div class="col-lg-10">
										<input type="text" id="judul_posting" name="judul_posting" class="form-control @error('judul_posting') is-invalid @enderror" placeholder="Judul berita" value="{{ old('judul_posting') }}">
										@error('judul_posting')
