...
<div class="form-group row" style="margin-bottom: 0.25rem">
    ...
    <div class="col-6">
        <label class="col-form-label col-lg-6">Institusi / lembaga<span class="text-danger">*</span></label>
        <div class="col-lg-12">
            <div class="form-group">
                {{Form::text('instansi', null, [ 'class' => 'form-control','placeholder' => 'Masukkan nama Institusi / lembaga','required'])}}
            </div>
        </div>
    </div>
</div>
...
<div class="form-group row" style="margin-bottom: 0.25rem">
    <div class="col-6">
        <label class="col-form-label col-lg-6">Informasi acara<span class="text-danger">*</span></label>
        <div class="col-lg-12">
...
<div class="text-right mt-5">
    <a href="{{route('liputan.index') }}" class="btn bg-grey-400">Kembali <i class="icon-square-left ml-2"></i></a>
