        ...
        <main id="content" role="main">
            ...
            <div class="container space-top-1 space-bottom-2">
                <div class="w-100 sm-6 mx-lg-auto">
                    <h3 class="mb-4 mt-10"><center>Form Ijin Kunjungan Data Server</center></h3>
                    <div class="w-lg-80 mx-auto">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!-- Form -->
                           {{Form::open(['route' => 'perijinan:kunjungan.dc.post'])}}
                                    <!-- Form Group -->
                                        ...
                                        <div class="alert bg-white w-lg-80 border shadow-sm mx-auto" role="alert">
                                            ...
                                            <div class="row align-items-sm-center">
                                                ...
                                                <div class="col-sm-4 text-sm-right">
                                                    <a href="{{route('perijinan:kunjungan.dc.create')}}" type="button" class="btn btn-sm btn-primary transition-3d-hover">Ok!</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
