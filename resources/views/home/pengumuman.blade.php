...
@section('title', 'Dinas Kominfo Wonosobo | Pengumuman')
    ...
    <div class="container space-top-3 space-top-lg-3 space-bottom-2">
     <div class="row">
      ...
      <div class="cbp"
           ...
           @foreach($pengumuman as $pengumumannya)
        <!-- Item -->
          ...
          <a class="cbp-caption" href="/details/{{$pengumumannya->id}}">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="d-flex justify-content-end flex-column h-100 p-4">
               <span class="topcorner text-white mt-2">{{  Carbon\Carbon::parse($pengumumannya->created_at)->isoFormat('dddd, D MMMM Y') }}</span>
                <span class="d-block h4 text-white mb-0">{{$pengumumannya->judul}}</span>
              </div>
            </div>
          </a>
        </div>
