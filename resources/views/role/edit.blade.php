...
<div class="content">
	<div class="card">
		...
		<div class="card-body">
			  {{Form::model($data, ['route' => ['role.update', $data->id],'method' => 'put',])}}
                            ...
                            <div class="col-md-3">
                                <div class="form-group m-form__group">
                                    <label class="m-checkbox" style="text-align: left">
                                        {!! Form::checkbox('permission[]', $item->name, in_array($item->name, $inPermission))!!} {{$item->display_name}}
                                        <span></span>
                                    </label>
                                </div>
                            </div>
